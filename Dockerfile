...
COPY . .
# ECOBE_API_URL: Server-side engine origin
...
# Platform env var overrides this default
ARG ECOBE_API_URL="http://localhost:3000"
...
# Platform runtime sets PORT dynamically
EXPOSE 3000
