...
function buildFrameDetail(
  ...
  replay: LiveSystemReplayResponse | null
): Omit<HallOGridFrameDetail, 'mirror'> {
...
export async function getHallOGridFrameDetail(
  decisionFrameId: string
): Promise<Omit<HallOGridFrameDetail, 'mirror'> | null> {
...
export async function getHallOGridSnapshot(): Promise<Omit<HallOGridSnapshot, 'access' | 'mirror'>> {
  const snapshot = await getCommandCenterSnapshot()
