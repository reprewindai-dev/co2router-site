  ...
  return (
    <div className="space-y-8 pb-10">
      <section className="surface-card-strong p-8">
        ...
        <h1 className="mt-3 text-4xl font-semibold text-white sm:text-5xl">Priced by control depth, not seats.</h1>
        <p className="mt-4 max-w-3xl text-base leading-7 text-slate-300">
          You pay for the decision points CO2 Router governs, the enforcement paths it protects,
          and the proof your team needs to keep. Start with one decision loop, prove the value,
          then expand into deeper enforcement, proof, and governance.
        </p>
      </section>
