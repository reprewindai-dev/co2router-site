    ...
    <div className="space-y-8 pb-10">
      <section className="surface-card-strong p-8">
        ...
        <p className="mt-4 max-w-3xl text-base leading-7 text-slate-300">
          ...
          buying reason. Start there and let the product prove itself quickly.
        </p>
      </section>
      ...
      <section className="grid gap-6 lg:grid-cols-2">
        <div className="surface-card p-6">
          ...
          <p className="mt-4 text-base leading-7 text-slate-300">
            One real workflow, one enforced path, proof visibility, and a live control-surface review
            tied to your actual workload shape.
          </p>
        </div>
        <div className="surface-card p-6">
