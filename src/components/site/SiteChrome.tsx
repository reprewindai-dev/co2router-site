...
function isConsolePath(pathname: string | null) {
...
export function SiteChrome({
  ...
  const consoleRoute = isConsolePath(pathname)
  ...
  return (
    <div className="min-h-screen bg-slate-950 bg-grid-mesh">
      ...
      <main className={consoleRoute ? 'w-full' : 'mx-auto w-full max-w-[1500px] px-4 py-6 sm:px-6'}>
        {children}
      </main>
